...
const Contact = () => {
  ...
  return (
    <div id="contact" className="text-left text-white mb-8">
      ...
      <p className="pb-3">Have a job for me? Reach me through any of the mediums below!</p>
      <div className="lg:grid lg:grid-cols-4 flex flex-col-reverse">
        <div className="flex lg:flex-col items-center  justify-evenly  py-3">
          <a href="https://twitter.com/hik_ari_" className="hover:text-blue-600 duration-300">
            <FaTwitter size={30} />
          </a>
          <a href="https://github.com/Hillaryd97" className="hover:text-blue-600 duration-300">
            <FaGithub size={30} />
          </a>
          <a href="https://www.linkedin.com/in/simidickson" className="hover:text-blue-600 duration-300">
            <FaLinkedin size={30} />
          </a>
          <a href="mailto:Hillaryd97@gmail.com" className="hover:text-blue-600 duration-300">
            <SiGmail size={30} />
          </a>
        </div>
        <form
